...
const HeroSection = () => {
  ...
  return (
    <>
      ...
      <section id="hero" className="relative text-white overflow-hidden px-4 py-[75px]" style={{ 
        paddingTop: '7vh', 
        paddingBottom: '7vh',
        ...
        <div className="container mx-auto text-center relative z-10 max-w-5xl">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold md:mb-4 leading-tight text-white my-0 py-0" style={{ fontFamily: "'Montserrat', sans-serif" }}>
            Почувствуй
          </h1>
          <h2 className="text-5xl md:text-7xl font-bold md:mb-6 leading-none pulse-icon px-4 my-[11px]" style={{ 
