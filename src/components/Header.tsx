...
const Header = () => {
  ...
  return (
    <header className="bg-white shadow-sm sticky top-0 z-50 py-3 md:px-6 md:py-5 px-[51px]">
      <div className="container flex items-center justify-between max-w-6xl mx-0 px-10">
        <button 
