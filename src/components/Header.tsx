...
const Header = () => {
  ...
  return (
    <header className="bg-white shadow-sm sticky top-0 z-50 my-0 px-0">
      <div className="container mx-auto flex items-center justify-between max-w-7xl my-0 py-0 px-0">
        <button 
