      ...
      <div className="container mx-auto flex items-center justify-between max-w-6xl px-0">
        ...
        >
          ...
          <div className="text-left">
            <h1 className="sm:text-xl md:text-2xl lg:text-3xl font-bold tracking-tight whitespace-nowrap text-lg" style={{ fontFamily: "'Montserrat', sans-serif", color: '#e67e22' }}>
              Ритмы Гор
            </h1>
            <p className="sm:text-xs md:text-sm text-gray-700 leading-tight mt-0.5 font-medium text-xs">
